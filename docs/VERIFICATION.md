...
| RLS-02 | Shared active-context, selection, and layout fixtures | Passed for reference | `ticker/fixtures/behavior-cases.json` and `docs/evidence/RLS-02/`; executable consumption required by RLS-03 |
| RLS-03 onward | Executable, lifecycle, artifact, acceptance | Not run | RLS-02 dependency |
