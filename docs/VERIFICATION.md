...
| MAC-01 | Native Swift/AppKit ticker parity and passive layout | Candidate; hosted gate pending | Swift package, shared-fixture tests, passive-panel tests, and focused `macos-ticker` job |
