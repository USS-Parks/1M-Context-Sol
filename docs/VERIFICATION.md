...
| CAC-11 | Atomic owned-setting apply, conflict refusal, and exact-byte rollback | Local gate passed; commit and remote CI pending | `src/config_manager.rs`, ownership schema, 12 config-manager tests, and isolated CLI proof |
